...
public abstract class AbstractDaoLogic<T extends ODataSet, S extends ODataEntity> implements LogicComponent<T> {
    ...
    public T setRelation(Map<String, Object> targetKeys, T sourceTo, Class<?> targetEntityClass,
        ...
        ODataEntity targetEntity = (ODataEntity) daoLogicHelper.getEntityByClassId(targetEntityClass, targetId);
    ...
    protected S doBeforeSetRelation(T abstractTo, ODataEntity targetEntity) {
    ...
    protected T doAfterSetRelation(S sourceEntity, ODataEntity targetEntity) {
